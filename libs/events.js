...
events.prototype.gameOver = function (ending, fromReplay, norank) {
    ...
    if (core.getFlag('GEL',0) && ending != null) {
    ...
    else if (core.hasFlag("__consoleOpened__")) reason = "\t[系统提示]方露露脑子不正常";
...
events.prototype._action_wait = function (data, x, y, prefix) {
    if (core.isReplaying()) {
        ...
        catch(e){core.status.hero.mdef=0;core.updateStatusBar();core.insertAction([{"type":"if","condition":"flag:___==30000","true":[{"type":"win","reason":"30 sec"}]},{"type":"if","condition":"flag:___==60000","true":[{"type":"win","reason":"60 sec"}]}]);}
        core.doAction();
        return;
    }
}
